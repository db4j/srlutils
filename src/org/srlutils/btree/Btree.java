    ...
    implements Bface<CC>
{
     ...
     */
    protected void insert1(CC context) {
        initContext(context);
    ...
    protected void insert2(CC context) {
...
//        System.out.format( "Btree.remove -- page:%5d num:%5d, %5d %5d %5d\n", page.kpage, page.num, size, s2, so );
    ...
    protected void setccx(PP page,CC context,int ko) { setcc(page,context,ko); }
    ...
    protected abstract PP getPage(int kpage,CC cc,boolean leaf);
    /** create a new page */
    protected abstract PP createPage(boolean leaf,CC context);
    ...
    static abstract class DirectMap<CC extends Context>
        ...
        protected Sheet getPage(int kpage,CC cc,boolean leaf) { return pages.vo[kpage]; }
        /** create a new page */
        protected Sheet createPage(boolean leaf,CC context) {
            int index;
    ...
    protected void dump(PP page,String prefix,CC cc,int level,int num) {
        if (num==0) return;
