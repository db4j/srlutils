...
public class DirectOrder {
    ...
    public static final boolean isOrdered = yes( which() );

    public static class DataRoot {
        public int [] order, obuf;
        Config cfg = DirectOrder.cfg;
        public DataRoot config(Config _cfg) { cfg = _cfg; return this; }
        public DataRoot order(int [] _order,int [] _obuf) {
            order = _order;
            obuf = _obuf;
            return this;
        }
    ...
    private static final int [] order(DataRoot zz) { return zz.order; }
    private static final int [] obuf(DataRoot zz) { return zz.obuf; }

    private static final Yes which() { return null; }
    ...
    /* XXX - remainder of this file is semi-auto-generated from Direct.java, see readme.txt */
